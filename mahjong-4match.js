const INITIAL_PREVIEW_SECONDS = 8;
const MISMATCH_DELAY_MS = 900;
const MATCH_DELAY_MS = 450;
const INITIAL_LEVEL = 1;
const INITIAL_PAIR_COUNT = 4;
const JUMP_STEP = 5;
...
function getPreviewSeconds() {
  return INITIAL_PREVIEW_SECONDS;
}
...
function renderJumpButtons(targetLevels) {
  if (!jumpButtonsElement || !jumpPanelElement) {
    return;
  }
